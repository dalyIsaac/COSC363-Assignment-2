...
public:
	...
	glm::vec3 xpt;	//The closest point of intersection on the ray, if found
	
	// The index of the object that gives the closest point of intersection.
	// -1 if the ray does not intersect any objects
	int xindex;	
